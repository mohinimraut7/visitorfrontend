...
const HeadOfficeMaster = () => {
  ...
  // Paginated data
  const paginatedOffices = offices.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage);
    ...
    <div style={gridStyle}>
      <Container maxWidth={false} sx={{ p: '0 !important' }}>
        <Paper elevation={0} sx={{ p: isMobile ? '20px 15px' : '30px 25px', borderRadius: '16px', bgcolor: 'white', boxShadow: 3 }}>
          ...
          {/* Full wrapper for vertical + horizontal scroll */}
          <Box
            sx={{
              borderRadius: '12px',
              boxShadow: '0 4px 20px rgba(0,0,0,0.08)',
          ...
          >
            ...
            <Box sx={{ overflowX: 'auto', flexGrow: 1, '&::-webkit-scrollbar': { height: 8 } }}>
              <Table stickyHeader sx={{ minWidth: 1000 }}>
                <TableHead>
                  <TableRow sx={{ bgcolor: '#f8f9fa' }}>
                    <TableCell align="center" sx={{ fontWeight: 700, color: '#495057', minWidth: 80 }}>Sr.No</TableCell>
                    <TableCell sx={{ fontWeight: 700, color: '#495057', minWidth: 140 }}>Office Type</TableCell>
                    <TableCell sx={{ fontWeight: 700, color: '#495057', minWidth: 220 }}>Office Name</TableCell>
